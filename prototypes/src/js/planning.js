...
angular.module('planning').service('planningService', function($http, planningAPI){
...
angular.module('planning').controller('planningController', function($scope, planningService){
    $scope.planning = {};
    ...
    $scope.success1 = function (response) {
        ...
        $scope.planning.cityname = response.data.name;
